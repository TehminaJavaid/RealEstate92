...
const SalesorderDetail = props => {
	...
	return (
		<div className={clsx(classes.root, 'flex-grow flex-shrink-0 p-0')}>
            ...
            {console.log("salesorder", props.salesorder)}
						<div className="mt-64" style={{marginTop: '80px'}}>
							<Table className="simple">
								...
								<TableBody>
                                {props.salesorder.details.map(detail => (
										<TableRow key={detail.id}>
											<TableCell>
												<Typography variant="subtitle1">{detail.item}</Typography>
											</TableCell>
											<TableCell align="right">{formatter.format(detail.price)}</TableCell>
									...
									<TableRow>
										...
										<TableCell align="right">
											<Typography
												...
												color="textSecondary"
											>
												{formatter.format(props.salesorder.total_tax)}
											</Typography>
										</TableCell>
									</TableRow>
									<TableRow>
										...
										<TableCell align="right">
											<Typography
												...
												color="textSecondary"
											>
												{formatter.format(props.salesorder.total_discount)}
											</Typography>
										</TableCell>
									</TableRow>
									<TableRow>
...
export default React.memo(SalesorderDetail);
