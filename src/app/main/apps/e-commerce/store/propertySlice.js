...
export const getProperty = createAsyncThunk('eCommerceApp/property/getProperty', async params => {
	console.log("yoooo")
...
export const getPropertyid = createAsyncThunk('eCommerceApp/property/getPropertyid', async () => {
...
export const editProperty = createAsyncThunk('eCommerceApp/property/editProperty', async salesorder => {
