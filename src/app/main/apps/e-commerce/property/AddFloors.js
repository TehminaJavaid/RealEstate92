...
function AddFloors(props) {
	...
	/*useEffect(() => {
		...
		console.log("dispatch",dispatch(saveFloors(state)));
	},[state]);*/
	
    /*useEffect(() => {
			console.log("first");
			dispatch(saveFloors(state));
	}, [dispatch]);*/
                                ...
                                {state.rows.map((item, idx) => (
										<TableRow key={idx}>
                                            ...
                                            <TextField 
                                                type="text"
                                                name="floor_name"
                                                value={state.rows[idx].floor_name}
...
export default withReducer('eCommerceApp', reducer)(AddFloors);
